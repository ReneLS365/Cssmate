...
const orgId = readEnv('VITE_AUTH0_ORG_ID') || readEnv('VITE_AUTH0_ORGANIZATION_ID')
const orgSlug = readEnv('VITE_AUTH0_ORG_SLUG') || readEnv('VITE_AUTH0_ORGANIZATION_SLUG')
...
const config = {
  ...
  VITE_AUTH0_ORG_ID: orgId,
  VITE_AUTH0_ORG_SLUG: orgSlug,
  VITE_AUTH0_ORGANIZATION_ID: readEnv('VITE_AUTH0_ORGANIZATION_ID'),
  VITE_AUTH0_ORGANIZATION_SLUG: readEnv('VITE_AUTH0_ORGANIZATION_SLUG'),
