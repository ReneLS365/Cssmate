...
const appCheckEnvKey = 'VITE_FIREBASE_APP_CHECK_SITE_KEY'
...
if (!process.env[appCheckEnvKey]) {
  console.warn('[firebase-env] Missing environment variable VITE_FIREBASE_APP_CHECK_SITE_KEY, using fallback (reCAPTCHA v3).')
}
...
const appCheckSiteKey = process.env[appCheckEnvKey] || appCheckFallbackKey
...
window.FIREBASE_APP_CHECK_SITE_KEY = ${JSON.stringify(appCheckSiteKey)};
