...
test('exportPDFBlob skaber akkordseddel med reference-overskrifter', async () => {
  ...
  const expectedHeadings = ['Akkordseddel', 'Sagsinfo', 'Materialer', 'Løn', 'Oversigt', 'Løn & projektsum', 'Detaljer', 'Materialer brugt', 'Arbejde', 'Materialeoversigt', 'Øvrige omkostninger'];
