...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    try {
      ...
      const workboxCore = self && self.workbox && self.workbox.core
      const cacheNames = workboxCore && workboxCore.cacheNames
      const precacheName = cacheNames && cacheNames.precache
      ...
      console.warn('SW install mislykkedes delvist', error)
    }
  })())
})
